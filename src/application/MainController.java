...
public class MainController {
    ...
    @FXML public ImageView expandArrow;
    ...
    public void onPlayButtonClick(MouseEvent mouseEvent) {
        ...
        if (radioStation == null) {
            radioStation = new RadioStation(radioStationList.firstKey(), radioStationList.firstEntry().getValue().getLogoPath(),
    ...
    private void changeRadioStation(boolean forward) {
        ...
        if (forward) {
            if (index < radioStationList.size() - 1) {
    ...
    public void onExpandArrowClick(MouseEvent mouseEvent) {
        if (expandArrow.getRotate() == 0) {
            stage.setHeight(210);
    ...
    public void onPlusImageViewClick(MouseEvent mouseEvent) {
        ...
        addChangeLabel.setText("Добавить");
        cleanTextFields();
        addChangeStationPaneShow(new ActionEvent());
    }
    ...
    public void onChangeMenuClick(ActionEvent actionEvent) {
        ...
        titleLabel.setText("Изменить радиостанцию");
        addChangeLabel.setText("Изменить");
        addChangeStationPaneShow(actionEvent);
        if (radioStation != null) {
    ...
    private void addChangeStationPaneShow(ActionEvent actionEvent) {
        expandArrow.setRotate(0);
